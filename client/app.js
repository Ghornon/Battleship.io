...
const main = () => {
	...
	createBoard(selectors.enemyGrid, boardWidth);
	...
	playerGrid.forEach(square => square.addEventListener('dragstart', event => {
		draggedShip = this;
	}));
	...
	// playerGrid.forEach(square => square.addEventListener('drop', dragEnd));
}
